...
async function main() {
    ...
    const tokenURI = "https://gateway.pinata.cloud/ipfs/Qmax9pXv3wTgSi4DsNa2msGuZL6nAuhm4bV1QBcKG47rGM";
    ...
    const a = await nft.getCurrentTokenId()
    console.log(await nft.tokenURI(a))
}
